...
def main() -> int:
    ...
    parser.add_argument("--plan", default="3000x20,6000x40,12000x80", help="Comma list of <total>x<concurrency>")
    ...
    print(f"[info] warmup={warmup_total}x{warmup_conc} plan={plan}")
